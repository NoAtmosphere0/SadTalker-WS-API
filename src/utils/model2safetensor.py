...
wav2lip_checkpoint = os.path.join(current_root_path, "data/checkpoints", "wav2lip.pth")

audio2pose_checkpoint = os.path.join(
    current_root_path, "data/checkpoints", "auido2pose_00140-model.pth"
)
...
audio2exp_checkpoint = os.path.join(
    current_root_path, "data/checkpoints", "auido2exp_00300-model.pth"
)
...
save_file(
    model.state_dict(),
    "data/checkpoints/SadTalker_V0.0.2_" + str(size) + ".safetensors",
)
