...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint-path", default="checkpoints", help="Path to SadTalker checkpoints"
    )
    parser.add_argument(
        "--config-path", default="src/config", help="Path to SadTalker config"
    )
    parser.add_argument(
        "--results-dir", default="results", help="Directory to save results"
    )
    parser.add_argument(
        "--static-dir", default="static", help="Directory for static files"
    )
